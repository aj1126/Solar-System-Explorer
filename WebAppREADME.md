# S. S. E. Web App ReadMe  
*An Interactive Orbital Plotter that can be used in a web browser*  
...
1. **Requirements:**  
   - Need Python installed on local machine [Python.org](https://www.python.org/)
